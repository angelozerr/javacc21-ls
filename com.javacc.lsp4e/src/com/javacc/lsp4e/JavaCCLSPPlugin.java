 ...
 * @author Angelo ZERR
 */
public class JavaCCLSPPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.redhat.qute.lsp4e"; //$NON-NLS-1$

	// The shared instance
	private static JavaCCLSPPlugin plugin;

	/**
	 * The constructor
	 */
	public JavaCCLSPPlugin() {
	}
	 ...
	 */
	public static JavaCCLSPPlugin getDefault() {
		return plugin;
	}

	public static String getPluginId() {
		return JavaCCLSPPlugin.PLUGIN_ID;
	}
